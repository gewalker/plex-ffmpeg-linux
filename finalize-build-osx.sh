gcc -bundle -flat_namespace -undefined suppress -read_only_relocs suppress -o ../../../../../system/players/dvdplayer/avutil-50-x86-osx.so libavutil/*.o libavutil/x86/*.o -fPIC -rdynamic -arch i386
...
gcc -bundle -flat_namespace -undefined suppress -read_only_relocs suppress -o ../../../../../system/players/dvdplayer/avcodec-52-x86-osx.so libavcodec/*.o libavcodec/x86/*.o -fPIC -rdynamic -arch i386
...
gcc -bundle -flat_namespace -undefined suppress -read_only_relocs suppress -o ../../../../../system/players/dvdplayer/avformat-52-x86-osx.so libavformat/*.o -fPIC -rdynamic -arch i386
...
gcc -bundle -flat_namespace -undefined suppress -read_only_relocs suppress -o ../../../../../system/players/dvdplayer/postproc-51-x86-osx.so libpostproc/*.o -fPIC -rdynamic -arch i386
